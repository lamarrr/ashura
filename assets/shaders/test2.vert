...
layout(set = 1, binding = 4,
       rgba8ui) uniform readonly uimageBuffer ro_imageBuffer;
layout(set = 2, binding = 5, rgba8ui) uniform writeonly uimage2D wo_image2D;
layout(set = 3, binding = 6,
       rgba8ui) uniform writeonly uimageBuffer wo_imageBuffer;
...
layout(set = 7, binding = 9,
       rgba8ui) uniform writeonly uimage2D rtextureBuffer3;
layout(set = 7, binding = 9,
       rgba8ui) uniform readonly uimageBuffer rtextureBuffer4;
