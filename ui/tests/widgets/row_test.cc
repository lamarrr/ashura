...
TEST(RowTest, BasicTest) {
  ...
  auto [request, monitor] =
      http.submit_task(http::Request{"https://mobz.github.io/lag-radar/"},
  ...
  /*
    ...
    to the " "level of the spectator on a hillside, the sable " "cloud beneath "
                            "was dished out, and the car seemed to float in the
    " "middle of an " "immense dark sphere, whose upper half was strewn " "with
    silver. "}, InlineText{"Looking down into the dark gulf below, I could "
                            "see a ruddy "
