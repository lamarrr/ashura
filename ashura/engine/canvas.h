...
struct ICanvas
{
    ...
    /// @brief The viewport's local extent. This will scale to the viewport's
    /// extent. This is typically the screen's virtual size (Logical px
    /// coordinates). This distinction helps support high-density displays.
    f32x2 extent_;
    ...
    /// @brief The world to viewport transformation matrix for the shader
    /// (-1.0, 1.0)
