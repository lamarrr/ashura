  ...
  void record_frame(f32 rot_x, f32 rot_z)
  {
    ...
    /*
        enc->clear_color_image(
            ...
            to_span({gfx::ImageSubresourceRange{.aspects =
       gfx::ImageAspects::Color, .first_mip_level   = 0, .num_mip_levels    = 1,
                                                .first_array_layer = 0,
                                                .num_array_layers  = 1}}));
       ...
       1}}, .aspect_ratio = .75 / .8, .albedo       = 0}}) .as_u8(), 0,
       params_buffer);
        ...
        blur.add_pass(
             ctx, BlurPassParams{
                      .rendering_info =
                          gfx::RenderingInfo{
                              .extent            =
       ctx.scratch_framebuffer.extent, .num_layers        = 1,
                              .color_attachments =
         to_span({gfx::RenderingAttachment{ .view =
