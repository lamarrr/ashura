...
struct CaretPlacement
{
    ...
    /// @brief the glyph the caret is placed relative to. None if there's no glyph
    /// on the line
...
struct TextRenderInfo
{
    ...
    /// @brief styling of the text block, contains styling for the runs and
    ...
    /// merged as the performance cost increases with increasing number of
    /// highlights
...
struct TextLayout
{
    ...
    /// @brief Given a position in the laid-out text return the caret the cursor
