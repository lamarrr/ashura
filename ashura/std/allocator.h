...
struct IAllocator
{
    ...
    /// @brief Allocate memory for `num` objects of type `T` with the memory
    /// padded to `alignment`
    template <typename T>
    ...
    /// @brief Allocate zeroed memory for `num` objects of type `T` with the
    /// memory padded to `alignment`
    template <typename T>
    ...
    /// @brief resize memory of `old_num` objects of type `T` to `new_num` with
    /// the memory padded to `alignment`
    template <typename T>
    ...
    /// @brief deallocate memory of `num` objects of type `T` with its padded
    /// alignment `alignment`
    template <typename T>
