...
#pragma once
#include "ashura/std/array.hpp"
#include "ashura/std/buffer.hpp"
...
struct Context
{
    ...
    {
        if (auto result = parse(fstr); result.error != Error::None)
        {
            return result;
        }
...
void format(fmt::Sink sink, fmt::Spec, f32x2 const & value);
void format(fmt::Sink sink, fmt::Spec, f32x3 const & value);
void format(fmt::Sink sink, fmt::Spec, f32x4 const & value);
void format(fmt::Sink sink, fmt::Spec, i32x2 const & value);
void format(fmt::Sink sink, fmt::Spec, i32x3 const & value);
void format(fmt::Sink sink, fmt::Spec, i32x4 const & value);
void format(fmt::Sink sink, fmt::Spec, u32x2 const & value);
void format(fmt::Sink sink, fmt::Spec, u32x3 const & value);
void format(fmt::Sink sink, fmt::Spec, u32x4 const & value);
