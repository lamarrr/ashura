...
/// In order to prevent accessing elements from dynamic offsets, we require that
/// the Type be placeable at the start of the storage.
///
/// x64 minimum size of Lambda = 3 Pointers = 24-bytes
/// x64 ideal configuration: Alignment = 32 bytes, Capacity = 48 bytes (Gives 64
/// bytes total. Fits exactly into one cacheline.
///
