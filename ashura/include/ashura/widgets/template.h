...
c.brush.color    = colors::WHITE;
auto    str      = std::format("Hello World! Examples Ashura Engine Demo.\n Starting in {}", d);
char    arstr[]  = {0xd9, 0x84, 0xd8, 0xa7, 0x20, 0xd8, 0xa5, 0xd9, 0x84, 0xd9, 0x87, 0x20,
                    0xd8, 0xa5, 0xd9, 0x84, 0xd8, 0xa7, 0x20, 0xd8, 0xa7, 0xd9, 0x84, 0xd9,
                    0x84, 0xd9, 0x87, 0x20, 0xd9, 0x88, 0xd8, 0xa7, 0xd9, 0x84, 0xd9, 0x84,
                    0xd9, 0x87, 0x20, 0xd8, 0xa3, 0xd9, 0x83, 0xd8, 0xa8, 0xd8, 0xb1, 0};
char    jpstr[]  = {0xe7, 0xa4, 0xbe, 0xe4, 0xbc, 0x9a, 0xe3, 0x81, 0xae, 0xe5, 0x90,
                    0x84, 0xe5, 0x80, 0x8b, 0xe4, 0xba, 0xba, 0xe5, 0x8f, 0x8a, 0xe3,
                    0x81, 0xb3, 0xe5, 0x90, 0x84, 0xe6, 0xa9, 0x9f, 0xe9, 0x96, 0xa2,
                    0xe3, 0x81, 0x8c, 0x20, 0xe3, 0x81, 0x93, 0xe3, 0x81, 0xae, 0xe4,
                    0xb8, 0x96, 0xe7, 0x95, 0x8c, 0xe4, 0xba, 0xba, 0xe6, 0xa8, 0xa9,
                    0xe5, 0xae, 0xa3, 0xe8, 0xa8, 0x80, 0xe3, 0x82, 0x92, 0xe5, 0xb8,
                    0xb8, 0xe3, 0x81, 0xab, 0xe5, 0xbf, 0xb5, 0xe9, 0xa0, 0xad, 0};
char    emojis[] = {0xf0, 0x9f, 0x98, 0x80, 0x20, 0xf0, 0x9f, 0x98, 0x83, 0x20, 0xf0, 0x9f,
...
TextRun runs[]   = {
    ...
    {.text  = str,
       .font  = 0,
       .style = TextStyle{.font_height         = 18,
