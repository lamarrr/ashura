...
struct Driver
{
  ...
  virtual void                     cmd_dispatch(gfx::CommandBuffer                          command_buffer,
  ...
  virtual void                     cmd_dispatch_indirect(gfx::CommandBuffer                          command_buffer,
                                                         ...
                                                         stx::Span<gfx::DescriptorSetBindings const> bindings,
                                                         stx::Span<u8 const>                         push_constants_data)                                                                               = 0;
  virtual void                     cmd_draw(gfx::CommandBuffer                          command_buffer,
                                            ...
                                            stx::Span<gfx::DescriptorSetBindings const> bindings,
                                            stx::Span<u8 const>                         push_constants_data)                                                                                            = 0;
  virtual void                     cmd_draw_indirect(gfx::CommandBuffer                          command_buffer,
                                                     gfx::GraphicsPipeline                       pipeline,
                                                     gfx::GraphicsState const                   &state,
                                                     stx::Span<gfx::Buffer const>                vertex_buffers,
                                                     gfx::Buffer                                 index_buffer,
                                                     ...
                                                     stx::Span<gfx::DescriptorSetBindings const> bindings,
                                                     stx::Span<u8 const>                         push_constants_data)                                                                                   = 0;
  virtual void                     cmd_insert_barriers(gfx::CommandBuffer                             command_buffer,
