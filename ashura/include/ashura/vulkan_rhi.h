...
#define ASH_VKDEV_FUNC(func_name) PFN_##vk##func_name func_name = nullptr
  ...
  ASH_VKDEV_FUNC(CmdPushDescriptorSetKHR);
...
{
  static constexpr char const *REQUIRED_EXTENSIONS[] = {"VK_KHR_push_descriptor", "VK_KHR_swapchain"};
  ...
  virtual gfx::DescriptorSetLayout create(gfx::DescriptorSetDesc const &descriptor_set_layout) override;
  ...
  virtual void                     cmd_fill_buffer(gfx::CommandBuffer command_buffer, gfx::Buffer buffer, u64 offset, u64 size, u32 data) override;
  virtual void                     cmd_copy_buffer(gfx::CommandBuffer command_buffer, gfx::Buffer src, gfx::Buffer dst, stx::Span<gfx::BufferCopy const> copies) override;
  virtual void                     cmd_update_buffer(gfx::CommandBuffer command_buffer, stx::Span<u8 const> src, u64 dst_offset, gfx::Buffer dst) override;
  virtual void                     cmd_copy_image(gfx::CommandBuffer command_buffer, gfx::Image src, gfx::Image dst, stx::Span<gfx::ImageCopy const> copies) override;
  virtual void                     cmd_copy_buffer_to_image(gfx::CommandBuffer command_buffer, gfx::Buffer src, gfx::Image dst, stx::Span<gfx::BufferImageCopy const> copies) override;
  ...
  virtual void                     cmd_set_blend_constants(gfx::CommandBuffer command_buffer, f32 r, f32 g, f32 b, f32 a) override;
  virtual void                     cmd_set_stencil_compare_mask(gfx::CommandBuffer command_buffer, gfx::StencilFaces faces, u32 compare_mask) override;
  virtual void                     cmd_set_stencil_reference(gfx::CommandBuffer command_buffer, gfx::StencilFaces faces, u32 reference) override;
  virtual void                     cmd_set_stencil_write_mask(gfx::CommandBuffer command_buffer, gfx::StencilFaces faces, u32 write_mask) override;
  virtual void                     cmd_dispatch(gfx::CommandBuffer command_buffer, u32 group_count_x, u32 group_count_y, u32 group_count_z) override;
  virtual void                     cmd_dispatch_indirect(gfx::CommandBuffer command_buffer, gfx::Buffer buffer, u64 offset) override;
  virtual void                     cmd_draw(gfx::CommandBuffer command_buffer, u32 first_vertex, u32 vertex_count, u32 instance_count, u32 first_instance_id) override;
  virtual void                     cmd_draw_indexed(gfx::CommandBuffer command_buffer, u32 first_index, u32 index_count, u32 instance_count, i32 vertex_offset, u32 first_instance_id) override;
  virtual void                     cmd_draw_indexed_indirect(gfx::CommandBuffer command_buffer, gfx::Buffer buffer, u64 offset, u32 draw_count, u32 stride) override;
  virtual void                     cmd_insert_barriers(gfx::CommandBuffer command_buffer, stx::Span<gfx::QueueBufferMemoryBarrier const> buffer_memory_barriers, stx::Span<gfx::QueueImageMemoryBarrier const> image_memory_barriers) override;
};
