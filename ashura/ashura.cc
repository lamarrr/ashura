...
int main(int argc, char **argv)
{
  ...
  AppConfig cfg{
      .enable_validation_layers = true, .fonts = fonts, .pipelines = pipelines};
  ...
  App           app{
      ...
      gui::Flex{
          ...
          gui::Text{"cruelty_free",
                    gui::TextProps{
                                  .style = TextStyle{.font = "MaterialIcons",
                                                     .font_height = 25,
          ...
          gui::Text{std::string_view{(char *) greeting, sizeof(greeting)},
                    gui::TextProps{
                                  .style = TextStyle{.font        = "NotoSans",
                                                     .font_height = 20,
                                                     .foreground_color = material::BLACK,
                                                     .background_color = colors::WHITE}}},
          gui::CheckBox{},
          gui::Slider{stx::fn::rc::make_unique_static(
              [](gui::Slider &slider, Context &ctx, f32 value) {
          ...
          gui::Stack{
              ...
              gui::Box{
                  ...
                  gui::Text{
                      "LIVE",
                      gui::TextProps{.style = TextStyle{.font_height = 15,
                                                                  .foreground_color =
                                                            colors::WHITE}}}}},
          gui::Stack{
          ...
          gui::Text{"verified",
                    gui::TextProps{.style = TextStyle{.font = "MaterialIcons",
                                                          ...
                                                          colors::YELLOW}}},
          gui::Text{
              R"(I didn't wanna say anything, but this game seems lame)",
              gui::TextProps{
                            .style = TextStyle{.font        = "Roboto",
                                               .font_height = 30,
          ...
          gui::Text{
              R"([2023-07-31 13:26:08.632] [Init] [info] WINDOW RESIZED
